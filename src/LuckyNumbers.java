public class LuckyNumbers
{
    ...
    public String getLuckyNumbers() {
        String luckyNums = "The lucky numbers are: " + randomIntegerBetween(1, 65) ;
        luckyNums += ", " + randomIntegerBetween(1, 65);
        luckyNums += ", " + randomIntegerBetween(1, 65);
        luckyNums += ", " + randomIntegerBetween(1, 65);
        luckyNums += ", and " + randomIntegerBetween(1, 65);
        String superNum = "\nThe super ball is " + randomIntegerBetween(1, 30);
        return luckyNums + superNum;
    }
}
